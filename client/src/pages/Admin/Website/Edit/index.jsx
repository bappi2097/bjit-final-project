...
const EditWebsite = () => {
    ...
    useEffect(() => {
        get("/admin/website/" + id).then(response => {
            dispatchState({ type: "NAME_INPUT", value: response.data.data.name, isValid: true });
            dispatchState({ type: "IMAGE_URL", value: process.env.REACT_APP_IMAGE_URL + response.data.data.logo, isValid: true });
            dispatchState({ type: "SLUG_INPUT", value: response.data.data.slug, isValid: true });
            dispatchState({ type: "THEME_INPUT", value: response.data.data.theme_id, isValid: true });
            dispatchState({ type: "DESIGN_INPUT", value: response.data.data.design, isValid: true });
            dispatchState({ type: "NAVBAR_INPUT", value: response.data.data.navbar_id, isValid: true });
            dispatchState({ type: "SECTION_INPUT", value: response.data.data.section_id, isValid: true });
            dispatchState({ type: "WEBSITE_TYPE_INPUT", value: response.data.data.website_type_id, isValid: true });
    ...
    return (
        <Card>
            ...
            <form onSubmit={formSubmitHandler}>
                ...
                <select onChange={websiteTypeChangeHandler} defaultValue={formState.websiteTypeId}>
                ...
                <label>User</label>
                <select onChange={userChangeHandler} defaultValue={formState.userId}>
                    <option>Choose</option>
                ...
                <label>Theme</label>
                <select onChange={themeChangeHandler} defaultValue={formState.theme}>
                    <option>Choose</option>
                ...
                <label>Navbar</label>
                <select onChange={navbarChangeHandler} defaultValue={formState.navbarId}>
                    <option>Choose</option>
