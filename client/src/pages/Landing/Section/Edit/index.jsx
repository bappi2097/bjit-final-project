...
const EditSection = () => {
    ...
    useEffect(() => {
        get("/admin/section/" + id).then(response => {
            dispatchState({ type: "NAME_INPUT", value: response.data.data.name, isValid: true });
            dispatchState({ type: "COMPONENT_NAME_INPUT", value: response.data.data.component_name, isValid: true });
            dispatchState({ type: "SETTING_INPUT", value: response.data.data.setting, isValid: true });
    ...
    return (
        <Card>
            ...
            <form onSubmit={formSubmitHandler}>
                ...
                <select onChange={websiteTypeChangeHandler} value={formState.websiteTypeId}>
